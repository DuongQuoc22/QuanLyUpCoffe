...
//            lblHinh.setIcon(new ImageIcon("unnamed.png"));
    ...
    public boolean checkRegex(){
        ...
        if(regex.matcher(txtGia.getText()).find()){
            JOptionPane.showMessageDialog(this, "Giá chứa ký tự đặc biệt, vui lòng xem lại!");
            txtGia.requestFocus();
            return false;
        }
        if(regex.matcher(txtMaSP.getText()).find()){
            JOptionPane.showMessageDialog(this, "Mã đồ uống chứa ký tự đặc biệt, vui lòng thử lại!");
            txtMaSP.setText("");
            txtMaSP.requestFocus();
            return false;
        }
